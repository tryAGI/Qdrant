...
{
    /// <inheritdoc />
    public class QuantizationConfigDiffJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.QuantizationConfigDiff>
    {
        /// <inheritdoc />
        public override global::Qdrant.QuantizationConfigDiff Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("scalar.memory")) __score0++;
            ...
            if (__jsonProps.Contains("product.memory")) __score1++;
            var __score2 = 0;
            ...
            if (__jsonProps.Contains("binary.memory")) __score2++;
            if (__jsonProps.Contains("binary.query_encoding")) __score2++;
            var __score3 = 0;
            if (__jsonProps.Contains("turbo")) __score3++;
            if (__jsonProps.Contains("turbo.always_ram")) __score3++;
            if (__jsonProps.Contains("turbo.bits")) __score3++;
            if (__jsonProps.Contains("turbo.memory")) __score3++;
            var __score4 = 0;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::Qdrant.TurboQuantization? turbo = default;
            global::Qdrant.DisabledType? disabledType = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Qdrant.QuantizationConfigDiff(
                scalar,
        ...
        public override void Write(
            ...
            global::Qdrant.QuantizationConfigDiff value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsTurbo)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.TurboQuantization), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Qdrant.TurboQuantization?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Qdrant.TurboQuantization).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Turbo!, typeInfo);
            }
