...
namespace Qdrant
{
    ...
    public readonly partial struct ReadConsistency : global::System.IEquatable<ReadConsistency>
    {
        ...
        /// </summary>
#if NET6_0_OR_GREATER
        public global::Qdrant.ReadConsistencyType? Type { get; init; }
#else
        public global::Qdrant.ReadConsistencyType? Type { get; }
#endif
        ...
        public ReadConsistency(
            ...
            global::Qdrant.ReadConsistencyType? type
            )
        {
        ...
        public TResult? Match<TResult>(
            ...
            global::System.Func<global::Qdrant.ReadConsistencyType?, TResult>? type = null,
            bool validate = true)
        {
            if (validate)
            {
