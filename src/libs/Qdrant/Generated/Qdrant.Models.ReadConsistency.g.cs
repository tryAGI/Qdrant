...
namespace Qdrant
{
    ...
    public readonly partial struct ReadConsistency : global::System.IEquatable<ReadConsistency>
    {
        ...
        /// </summary>
#if NET6_0_OR_GREATER
        public global::Qdrant.ReadConsistencyType? Value2 { get; init; }
#else
        public global::Qdrant.ReadConsistencyType? Value2 { get; }
#endif
        ...
        /// 
        /// </summary>
        public static implicit operator global::Qdrant.ReadConsistencyType?(ReadConsistency @this) => @this.Value2;
        ...
        public ReadConsistency(
            int? value1,
            global::Qdrant.ReadConsistencyType? value2
            )
        {
            Value1 = value1;
            Value2 = value2;
        ...
        public TResult? Match<TResult>(
            ...
            global::System.Func<global::Qdrant.ReadConsistencyType?, TResult>? value2 = null,
            bool validate = true)
        {
            if (validate)
            {
        ...
        public void Match(
            ...
            global::System.Action<global::Qdrant.ReadConsistencyType?>? value2 = null,
            bool validate = true)
        {
            if (validate)
            {
        ...
        public override int GetHashCode()
        {
            var fields = new object?[]
            {
                ...
                typeof(int),
                Value2,
                typeof(global::Qdrant.ReadConsistencyType),
            };
        ...
        public bool Equals(ReadConsistency other)
        {
            return
                ...
                global::System.Collections.Generic.EqualityComparer<global::Qdrant.ReadConsistencyType?>.Default.Equals(Value2, other.Value2) 
                ;
        }
