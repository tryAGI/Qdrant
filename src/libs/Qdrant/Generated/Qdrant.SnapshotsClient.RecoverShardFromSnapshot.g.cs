...
namespace Qdrant
{
    public partial class SnapshotsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.RecoverShardFromSnapshotResponse> RecoverShardFromSnapshotAsync(
            string collectionName,
            int shardId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Qdrant.AutoSDKHttpResponse<global::Qdrant.RecoverShardFromSnapshotResponse>> RecoverShardFromSnapshotAsResponseAsync(
            string collectionName,
            int shardId,
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Qdrant.RecoverShardFromSnapshotResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Qdrant.AutoSDKHttpResponse<global::Qdrant.RecoverShardFromSnapshotResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Qdrant.RecoverShardFromSnapshotResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.RecoverShardFromSnapshotResponse> RecoverShardFromSnapshotAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Qdrant.ShardSnapshotRecover
            {
                Location = location,
                Priority = priority,
                Checksum = checksum,
