...
{
    /// <inheritdoc />
    public class IdfParamsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.IdfParams>
    {
        /// <inheritdoc />
        public override global::Qdrant.IdfParams Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            var __score1 = 0;
            if (__jsonProps.Contains("corpus")) __score1++;
            if (__jsonProps.Contains("corpus.min_should")) __score1++;
            if (__jsonProps.Contains("corpus.must")) __score1++;
            if (__jsonProps.Contains("corpus.must_not")) __score1++;
            if (__jsonProps.Contains("corpus.should")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::Qdrant.IdfScope? scope = default;
            global::Qdrant.IdfCorpusParams? corpus = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        scope = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        corpus = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::Qdrant.IdfParams(
                scope,
