...
{
    /// <inheritdoc />
    public class OptimizersStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.OptimizersStatus>
    {
        /// <inheritdoc />
        public override global::Qdrant.OptimizersStatus Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Qdrant.OptimizersStatusEnum? value1 = default;
            global::Qdrant.OptimizersStatusEnum2? value2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Qdrant.OptimizersStatus(
                value1,
        ...
        public override void Write(
            ...
            global::Qdrant.OptimizersStatus value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
