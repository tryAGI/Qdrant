...
{
    /// <inheritdoc />
    public class WithVectorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.WithVector>
    {
        /// <inheritdoc />
        public override global::Qdrant.WithVector Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            bool? withVectorVariant1 = default;
            global::System.Collections.Generic.IList<string>? withVectorVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        withVectorVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        withVectorVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::Qdrant.WithVector(
                withVectorVariant1,
        ...
        public override void Write(
            ...
            global::Qdrant.WithVector value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsWithVectorVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(bool), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<bool> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(bool).Name}");
