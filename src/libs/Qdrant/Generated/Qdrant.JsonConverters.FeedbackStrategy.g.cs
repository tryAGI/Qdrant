...
{
    /// <inheritdoc />
    public class FeedbackStrategyJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.FeedbackStrategy>
    {
        /// <inheritdoc />
        public override global::Qdrant.FeedbackStrategy Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("naive.a")) __score0++;
            if (__jsonProps.Contains("naive.b")) __score0++;
            if (__jsonProps.Contains("naive.c")) __score0++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }

            global::Qdrant.NaiveFeedbackStrategy? naive = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Qdrant.FeedbackStrategy(
                naive
                );
        ...
        public override void Write(
            ...
            global::Qdrant.FeedbackStrategy value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
