...
namespace Qdrant
{
    ...
    public sealed partial class BoolIndexParams
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Qdrant.JsonConverters.BoolIndexTypeJsonConverter))]
        public global::Qdrant.BoolIndexType Type { get; set; }
        ...
        public BoolIndexParams(
            global::Qdrant.BoolIndexType type,
            bool? onDisk,
            bool? enableHnsw)
        {
            this.Type = type;
