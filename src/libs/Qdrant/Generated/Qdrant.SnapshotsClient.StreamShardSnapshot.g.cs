...
namespace Qdrant
{
    public partial class SnapshotsClient
    {
        ...
        {
            var __response = await StreamShardSnapshotAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> StreamShardSnapshotAsStreamAsync(
            string collectionName,
            int shardId,
            global::Qdrant.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Qdrant.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StreamShardSnapshot",
                                methodName: "StreamShardSnapshotAsync",
                                pathTemplate: "$\"/collections/{collectionName}/shards/{shardId}/snapshot\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            try
                            {
                                ...
                                return new global::Qdrant.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Qdrant.AutoSDKHttpResponse<byte[]>> StreamShardSnapshotAsResponseAsync(
            string collectionName,
            int shardId,
            global::Qdrant.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Qdrant.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
