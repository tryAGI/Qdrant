...
namespace Qdrant
{
    ...
    public sealed partial class LocalShardTelemetry
    {
        ...
        public global::Qdrant.ShardUpdateQueueInfo? UpdateQueue { get; set; }
        ...
        public LocalShardTelemetry(
            ...
            string? variantName,
            global::Qdrant.ShardStatus? status,
            int? vectorsSizeBytes,
            int? payloadsSizeBytes,
            int? numPoints,
            int? numVectors,
            global::System.Collections.Generic.Dictionary<string, int>? numVectorsByName,
            global::System.Collections.Generic.IList<global::Qdrant.SegmentTelemetry>? segments,
            global::Qdrant.OptimizerTelemetry? optimizations,
            bool? asyncScorer,
