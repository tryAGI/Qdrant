...
namespace Qdrant
{
    public partial interface IDistributedClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Qdrant.ClusterTelemetryResponse> ClusterTelemetryAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Qdrant.AutoSDKHttpResponse<global::Qdrant.ClusterTelemetryResponse>> ClusterTelemetryAsResponseAsync(
            int? detailsLevel = default,
            int? timeout = default,
            global::Qdrant.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
