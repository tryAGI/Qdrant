...
{
    /// <inheritdoc />
    public class ReadConsistencyJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.ReadConsistency>
    {
        /// <inheritdoc />
        public override global::Qdrant.ReadConsistency Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.ReadConsistencyType), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
        ...
        public override void Write(
            ...
            global::Qdrant.ReadConsistency value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
