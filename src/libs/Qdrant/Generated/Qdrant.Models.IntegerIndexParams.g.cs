...
namespace Qdrant
{
    ...
    public sealed partial class IntegerIndexParams
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Qdrant.JsonConverters.IntegerIndexTypeJsonConverter))]
        public global::Qdrant.IntegerIndexType Type { get; set; }
        ...
        public IntegerIndexParams(
            global::Qdrant.IntegerIndexType type,
            bool? lookup,
            bool? range,
            bool? isPrincipal,
            bool? onDisk,
