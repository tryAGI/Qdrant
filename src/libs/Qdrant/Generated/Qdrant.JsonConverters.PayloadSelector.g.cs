...
{
    /// <inheritdoc />
    public class PayloadSelectorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.PayloadSelector>
    {
        /// <inheritdoc />
        public override global::Qdrant.PayloadSelector Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Qdrant.PayloadSelectorInclude? include = default;
            global::Qdrant.PayloadSelectorExclude? exclude = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Qdrant.PayloadSelector(
                include,
        ...
        public override void Write(
            ...
            global::Qdrant.PayloadSelector value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
