...
namespace Qdrant
{
    public partial class IndexesClient
    {
        ...
        partial void PrepareDeleteFieldIndexArguments(
            ...
            ref int? timeout);
        partial void PrepareDeleteFieldIndexRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout);
        partial void ProcessDeleteFieldIndexResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteFieldIndexResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.DeleteFieldIndexResponse> DeleteFieldIndexAsync(
            string collectionName,
            string fieldName,
            bool? wait = default,
        ...
        {
            var __response = await DeleteFieldIndexAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Qdrant.AutoSDKHttpResponse<global::Qdrant.DeleteFieldIndexResponse>> DeleteFieldIndexAsResponseAsync(
            string collectionName,
            string fieldName,
            bool? wait = default,
            global::Qdrant.WriteOrdering? ordering = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteFieldIndexArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Qdrant.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteFieldIndex",
                                methodName: "DeleteFieldIndexAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteFieldIndexResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteFieldIndexResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Qdrant.DeleteFieldIndexResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Qdrant.AutoSDKHttpResponse<global::Qdrant.DeleteFieldIndexResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Qdrant.DeleteFieldIndexResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
