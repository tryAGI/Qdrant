...
namespace Qdrant
{
    public partial class CollectionsClient
    {
        ...
        private static readonly global::Qdrant.EndPointSecurityRequirement s_CreateVectorNameSecurityRequirement0 =
        ...
        private static readonly global::Qdrant.EndPointSecurityRequirement[] s_CreateVectorNameSecurityRequirements =
            new global::Qdrant.EndPointSecurityRequirement[]
            {                s_CreateVectorNameSecurityRequirement0,
            };
        partial void PrepareCreateVectorNameArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string collectionName,
            ref string vectorName,
            ref bool? wait,
            ref global::Qdrant.WriteOrdering? ordering,
            ref int? timeout,
            global::Qdrant.VectorNameConfig request);
        partial void PrepareCreateVectorNameRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout,
            global::Qdrant.VectorNameConfig request);
        partial void ProcessCreateVectorNameResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVectorNameResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.CreateVectorNameResponse> CreateVectorNameAsync(
            string collectionName,
            string vectorName,
        ...
        {
            var __response = await CreateVectorNameAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Qdrant.AutoSDKHttpResponse<global::Qdrant.CreateVectorNameResponse>> CreateVectorNameAsResponseAsync(
            string collectionName,
            string vectorName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVectorNameArguments(
                httpClient: HttpClient,
                collectionName: ref collectionName,
                vectorName: ref vectorName,
                wait: ref wait,
            ...
            var __authorizations = global::Qdrant.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVectorNameSecurityRequirements,
                operationName: "CreateVectorNameAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Qdrant.PathBuilder(
                                path: $"/collections/{collectionName}/vectors/{vectorName}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVectorNameRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Qdrant.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateVectorName",
                                methodName: "CreateVectorNameAsync",
                                pathTemplate: "$\"/collections/{collectionName}/vectors/{vectorName}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVectorNameResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode >= 400 && (int)__response.StatusCode <= 499)
                            {
                                ...
                                throw global::Qdrant.ApiException<global::Qdrant.ErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVectorNameResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Qdrant.CreateVectorNameResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Qdrant.AutoSDKHttpResponse<global::Qdrant.CreateVectorNameResponse>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw global::Qdrant.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Qdrant.CreateVectorNameResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.CreateVectorNameResponse> CreateVectorNameAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Qdrant.VectorNameConfig
            {
            };

            return await CreateVectorNameAsync(
                collectionName: collectionName,
                vectorName: vectorName,
                wait: wait,
                ordering: ordering,
