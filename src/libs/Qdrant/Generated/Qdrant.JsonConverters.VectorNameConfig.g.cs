...
{
    /// <inheritdoc />
    public class VectorNameConfigJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.VectorNameConfig>
    {
        /// <inheritdoc />
        public override global::Qdrant.VectorNameConfig Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            if (__jsonProps.Contains("dense")) __score0++;
            if (__jsonProps.Contains("dense.datatype")) __score0++;
            if (__jsonProps.Contains("dense.distance")) __score0++;
            if (__jsonProps.Contains("dense.multivector_config")) __score0++;
            if (__jsonProps.Contains("dense.size")) __score0++;
            var __score1 = 0;
            if (__jsonProps.Contains("sparse")) __score1++;
            if (__jsonProps.Contains("sparse.datatype")) __score1++;
            if (__jsonProps.Contains("sparse.modifier")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::Qdrant.DenseVectorNameConfig? dense = default;
            global::Qdrant.SparseVectorNameConfig? sparse = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        dense = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            var __value = new global::Qdrant.VectorNameConfig(
                dense,
        ...
        public override void Write(
            ...
            global::Qdrant.VectorNameConfig value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
