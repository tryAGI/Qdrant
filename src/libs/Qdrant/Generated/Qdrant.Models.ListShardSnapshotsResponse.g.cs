...
namespace Qdrant
{
    ...
    public sealed partial class ListShardSnapshotsResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListShardSnapshotsResponse" /> class.
        /// </summary>
        /// <param name="usage">
        /// Default Value: openapi-json-null-sentinel-value-2BF93600-0FE4-4250-987A-E5DDB203E464
        /// </param>
...
#endif
        public ListShardSnapshotsResponse(
            global::Qdrant.Usage? usage,
            float? time,
            string? status,
            global::System.Collections.Generic.IList<global::Qdrant.SnapshotDescription>? result)
        {
            this.Usage = usage;
            this.Time = time;
            this.Status = status;
