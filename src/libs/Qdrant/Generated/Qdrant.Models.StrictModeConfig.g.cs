...
namespace Qdrant
{
    ...
    public sealed partial class StrictModeConfig
    {
        ...
        public global::System.Collections.Generic.Dictionary<string, global::Qdrant.StrictModeMultivector>? MultivectorConfig { get; set; }

        /// <summary>
        /// Sparse vector strict mode configuration
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("sparse_config")]
        public global::System.Collections.Generic.Dictionary<string, global::Qdrant.StrictModeSparse>? SparseConfig { get; set; }
        ...
        /// <summary>
        /// Deprecated: use the node-wide quota config (`PUT /quotas`) instead, which caps the same resource for every collection. Scheduled for removal in 1.21.<br/>
