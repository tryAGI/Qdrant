...
namespace Qdrant
{
    public partial class SearchClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.SearchMatrixPairsResponse2> SearchMatrixPairsAsync(
            string collectionName,
        ...
        {
            var __response = await SearchMatrixPairsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Qdrant.AutoSDKHttpResponse<global::Qdrant.SearchMatrixPairsResponse2>> SearchMatrixPairsAsResponseAsync(
            string collectionName,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Qdrant.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SearchMatrixPairs",
                                methodName: "SearchMatrixPairsAsync",
                                pathTemplate: "$\"/collections/{collectionName}/points/search/matrix/pairs\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Qdrant.SearchMatrixPairsResponse2.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Qdrant.AutoSDKHttpResponse<global::Qdrant.SearchMatrixPairsResponse2>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Qdrant.SearchMatrixPairsResponse2.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
