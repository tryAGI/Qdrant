...
{
    /// <inheritdoc />
    public class QueryInterfaceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.QueryInterface>
    {
        /// <inheritdoc />
        public override global::Qdrant.QueryInterface Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.VectorInput), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.Query), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::Qdrant.VectorInput? vectorInput = default;
            global::Qdrant.Query? query = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Qdrant.QueryInterface(
                vectorInput,
        ...
        public override void Write(
            ...
            global::Qdrant.QueryInterface value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
