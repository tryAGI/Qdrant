...
namespace Qdrant
{
    ...
    public sealed partial class SegmentInfo
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Qdrant.JsonConverters.SegmentTypeJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        ...
        public SegmentInfo(
            ...
            global::Qdrant.SegmentType segmentType,
            int numVectors,
            int numPoints,
            ...
            int diskUsageBytes,
            bool isAppendable,
            global::System.Collections.Generic.Dictionary<string, global::Qdrant.PayloadIndexInfo> indexSchema,
