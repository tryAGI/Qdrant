...
namespace Qdrant
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Qdrant.AutoSDKRetryOptions Retry { get; set; } = new global::Qdrant.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Qdrant.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Qdrant.IAutoSDKHook>();
        ...
        public global::Qdrant.AutoSDKClientOptions AddHook(
            global::Qdrant.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Qdrant.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Qdrant.AutoSDKClientOptions UseAuthorizationProvider(
            global::Qdrant.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Qdrant.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Qdrant.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Qdrant.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Qdrant.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Qdrant.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Qdrant.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Qdrant.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Qdrant.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Qdrant.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Qdrant.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Qdrant.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Qdrant.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Qdrant.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Qdrant.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Qdrant.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Qdrant.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Qdrant.AutoSDKClientOptions clientOptions,
            global::Qdrant.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Qdrant.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Qdrant.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Qdrant.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Qdrant.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Qdrant.IAutoSDKHook, global::Qdrant.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Qdrant.AutoSDKHookContext context)
        {
