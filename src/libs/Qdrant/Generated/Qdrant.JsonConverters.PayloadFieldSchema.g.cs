...
{
    /// <inheritdoc />
    public class PayloadFieldSchemaJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.PayloadFieldSchema>
    {
        /// <inheritdoc />
        public override global::Qdrant.PayloadFieldSchema Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.PayloadSchemaType), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.PayloadSchemaParams), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::Qdrant.PayloadSchemaType? type = default;
            global::Qdrant.PayloadSchemaParams? @params = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Qdrant.PayloadFieldSchema(
                type,
        ...
        public override void Write(
            ...
            global::Qdrant.PayloadFieldSchema value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
