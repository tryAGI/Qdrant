...
namespace Qdrant
{
    ...
    public sealed partial class DistributedClusterTelemetry
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.Dictionary<string, global::Qdrant.DistributedPeerInfo> Peers { get; set; }
        ...
        public DistributedClusterTelemetry(
            bool enabled,
            global::System.Collections.Generic.Dictionary<string, global::Qdrant.DistributedPeerInfo> peers,
            int? numberOfPeers)
        {
