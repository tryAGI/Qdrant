...
namespace Qdrant
{
    public partial class CollectionsClient
    {
        ...
        private static readonly global::Qdrant.EndPointSecurityRequirement s_DeleteVectorNameSecurityRequirement0 =
        ...
        private static readonly global::Qdrant.EndPointSecurityRequirement[] s_DeleteVectorNameSecurityRequirements =
            new global::Qdrant.EndPointSecurityRequirement[]
            {                s_DeleteVectorNameSecurityRequirement0,
            };
        partial void PrepareDeleteVectorNameArguments(
            ...
            ref int? timeout);
        partial void PrepareDeleteVectorNameRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout);
        partial void ProcessDeleteVectorNameResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteVectorNameResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Delete named vector<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.DeleteVectorNameResponse> DeleteVectorNameAsync(
            string collectionName,
            string vectorName,
            bool? wait = default,
        ...
        {
            var __response = await DeleteVectorNameAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Qdrant.AutoSDKHttpResponse<global::Qdrant.DeleteVectorNameResponse>> DeleteVectorNameAsResponseAsync(
            string collectionName,
            string vectorName,
            bool? wait = default,
            global::Qdrant.WriteOrdering? ordering = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteVectorNameArguments(
            ...
            var __authorizations = global::Qdrant.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteVectorNameSecurityRequirements,
                operationName: "DeleteVectorNameAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteVectorNameRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Qdrant.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteVectorName",
                                methodName: "DeleteVectorNameAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteVectorNameResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteVectorNameResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Qdrant.DeleteVectorNameResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Qdrant.AutoSDKHttpResponse<global::Qdrant.DeleteVectorNameResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Qdrant.DeleteVectorNameResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
