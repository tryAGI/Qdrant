...
{
    /// <inheritdoc />
    public class VectorStorageTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Qdrant.VectorStorageType>
    {
        /// <inheritdoc />
        public override global::Qdrant.VectorStorageType Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.VectorStorageTypeVariant1), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.VectorStorageTypeVariant2), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score2 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.VectorStorageTypeVariant3), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score3 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.VectorStorageTypeVariant4), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score4 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.VectorStorageTypeVariant5), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score5 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Qdrant.VectorStorageTypeVariant6), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::Qdrant.VectorStorageTypeVariant1? vectorStorageTypeVariant1 = default;
            global::Qdrant.VectorStorageTypeVariant2? vectorStorageTypeVariant2 = default;
            global::Qdrant.VectorStorageTypeVariant3? vectorStorageTypeVariant3 = default;
            global::Qdrant.VectorStorageTypeVariant4? vectorStorageTypeVariant4 = default;
            global::Qdrant.VectorStorageTypeVariant5? vectorStorageTypeVariant5 = default;
            global::Qdrant.VectorStorageTypeVariant6? vectorStorageTypeVariant6 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 5)
                {
                    try
                    {
                        ...
                        vectorStorageTypeVariant6 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::Qdrant.VectorStorageType(
        ...
        public override void Write(
            ...
            global::Qdrant.VectorStorageType value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
