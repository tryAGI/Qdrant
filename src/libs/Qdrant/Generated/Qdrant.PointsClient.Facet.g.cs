                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Qdrant.FacetResponse2.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Qdrant.FacetResponse2.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
