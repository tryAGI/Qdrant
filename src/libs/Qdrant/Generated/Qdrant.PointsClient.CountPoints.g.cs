...
namespace Qdrant
{
    public partial class PointsClient
    {
        ...
        partial void PrepareCountPointsArguments(
            ...
            ref int? timeout,
            global::Qdrant.CountRequest request);
        partial void PrepareCountPointsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout,
            global::Qdrant.CountRequest request);
        partial void ProcessCountPointsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCountPointsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.CountPointsResponse> CountPointsAsync(
            string collectionName,
        ...
        {
            var __response = await CountPointsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Qdrant.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Qdrant.AutoSDKHttpResponse<global::Qdrant.CountPointsResponse>> CountPointsAsResponseAsync(
            string collectionName,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Qdrant.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CountPointsAsync",
                                pathTemplate: "$\"/collections/{collectionName}/points/count\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Qdrant.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCountPointsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Qdrant.CountPointsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Qdrant.AutoSDKHttpResponse<global::Qdrant.CountPointsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Qdrant.CountPointsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Qdrant.CountPointsResponse> CountPointsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Qdrant.CountRequest
            {
                ShardKey = shardKey,
                Filter = filter,
                Exact = exact,
